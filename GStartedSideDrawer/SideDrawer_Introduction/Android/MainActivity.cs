...
namespace SideDrawer_Introduction.Android
{
    [Activity(Label = "SideDrawer_Introduction.Android", Icon = "@drawable/icon", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
