	...
	public class SelectedPointLabel : CALayer
	{
		...
		public override void DrawInContext (CGContext ctx)
		{
			...
			if (this.IsOutsideBounds == true) {
				...
				textRect = new RectangleF (bounds.Left, bounds.Top - this.LabelStyle.Insets.Top + shape.ArrowSize.Height, bounds.Size.Width, bounds.Size.Height + this.LabelStyle.Insets.Bottom);
			} else {
				textRect = new RectangleF (bounds.Left, bounds.Top - this.LabelStyle.Insets.Top, bounds.Size.Width, bounds.Size.Height + this.LabelStyle.Insets.Bottom);
			}
